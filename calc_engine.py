# -*- coding: utf-8 -*-
"""
이유마켓 CEO Margin Pro - 계산 엔진 (단일 소스)
...
DEFAULT_FEES = {
    ...
    "TOSS": [8.8, 1.76, 1.76, 0.0, 8900, 12.0],
...
STATUS_CODE_MAP = {
    '1': '신규주문', '2': '배송중', '3': '배송완료', '4': '구매확정',
    '11': '취소', '12': '취소철회',
    '20': '반품요청', '21': '반품', '22': '반품철회',
    '30': '교환요청', '31': '교환완료',
    '99': '발주취소',
    '신규주문(1)': '신규주문', '배송중(2)': '배송중', '배송완료(3)': '배송완료',
    '구매확정(4)': '구매확정', '취소(11)': '취소', '취소철회(12)': '취소철회',
